 ...
 */
public class Tagger {
    private static Character feedFileSeparator = '\t';
    private static Character tagFileSeparator = '\t';
...
//                "/home/damian/Pulpit/Studia 16-17/Semestr 6/IO/TaggedFeeds/OrgTag");
    ...
    public static void tagFileByCountry(String tagsFilePath, String sourceFilePath, String destinationFilePath){
    ...
    private static void tagFile(String tagsFilePath, String sourceFilePath, String destinationFilePath,
        ...
        List<String> tags = ReaderCsv.readAtPosition(tagsFilePath, 0, tagFileSeparator);
        List<String> tagsKeys = ReaderCsv.readAtPosition(tagsFilePath,  1, tagFileSeparator);
